  ...
  function resume_get() {
    ...
    fetch("/resume_show/" + number)
      ...
      .then((data) => {
        ...
        resume.forEach((a) => {
        let name = a["name"];
        let contacts = a["contacts"];
        let email = a["email"];
        let desired_position = a["desired_position"];
        let desired_role = a["desired_role"];
        let desired_work_exp = a["desired_work_exp"];
        let desired_maj_skill = a["desired_maj_skill"];
        let last_school_name = a["last_school_name"];
        let last_comp_stat = a["last_comp_stat"];
        let last_major = a["last_major"];
        let resumbox = a["resumbox"];
